  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div>
        ...
        <form action="{{ route('dashboard.user.update', $item->id) }}" class="full-w" method="POST"
          ...
          <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full px-3">
              ...
              <input type="text" value="{{ old('name') ?? $item->name }}" name="name" placeholder="user name"
          ...
          <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full px-3">
              ...
              <input type="email" value="{{ old('email') ?? $item->email }}" name="email" placeholder="usera email"
                class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
            </div>
          </div>
